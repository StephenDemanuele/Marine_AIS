...
namespace AIS.Parser.Models.Messages
{
    public class MessageType1 : IMessage
    {
        ...
        internal MessageType1(string bitVector)
        {
            BitVector = bitVector;
            ...
            //TODO: what is navigational status for BaseStation? 
            var navigationalStatus = Convert.ToInt32(BitVector.Substring(_propDict[nameof(NavigationalStatus)].Ordinal, _propDict[nameof(NavigationalStatus)].BitCount), 2);
            NavigationalStatus = (NavStatus)navigationalStatus;
